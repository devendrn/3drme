...
template <class Archive> void serialize(Archive& archive, Viewport& d) { archive(d.camera, d.downscaleFactor, d.raymarchSteps, d.reflRaymarchSteps, d.raymarchingClipStart, d.raymarchingClipEnd, d.raymarchingPixelRadius, d.taaFeedbackFactor, d.occlusionFactor, d.occlusionRadius, d.ambientColor, d.ambientIntensity, d.fogFadeIn); }
